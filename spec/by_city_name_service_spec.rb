...
describe Weatherio do
  context 'text' do
    ...
    before(:all) do
      ...
      @weatherresults = @weatherio.get_weather_by_city_name("Abuja")
    end
    ...
    #   expect(@weatherio.get_main_pressure).to be_kind_of(Float)
    # end
    #
    ...
    it "i expect the data type of the main_sea_level key to be a float" do
      #check if the key exists first,if it does, it must be a float. if it does not, expect it to be null
      if @weatherio.get_main.key?("sea_level") == true
        expect(@weatherio.get_main_sea_level).to be_kind_of(Float)
      else
        expect(@weatherio.get_main_sea_level).to be_nil
      end
    end

    it "i expect the data type of the main_grnd_level key to be a float" do
      if @weatherio.get_main.key?("grnd_level") == true
        expect(@weatherio.get_main_grnd_level).to be_kind_of(Float)
      else
        expect(@weatherio.get_main_grnd_level).to be_nil
      end
    end
    #
    # it "i expect the data type of the main_grnd_level key to be a float" do
    ...
    #   expect(@weatherio.get_wind_speed).to be_kind_of(Float)
    # end
    #
    # it "i expect the data type of the wind_deg key to be a integer" do
    #   expect(@weatherio.get_wind_deg).to be_kind_of(Integer)
    # end

    # it "i expect the data type of the clouds_all key to be a float" do
    #   expect(@weatherio.get_clouds_all).to be_kind_of(Float)
    # end
    #
    # it "i expect the data type of the sys_type key to be a float" do
    #   expect(@weatherio.get_sys_type).to be_kind_of(Float)
    # end
    #
    # it "i expect the data type of the sys_id key to be a float" do
    #   expect(@weatherio.get_sys_id).to be_kind_of(Float)
    # end
    #
    #
    # it "i expect the data type of the sys_message key to be a float" do
    #   expect(@weatherio.get_sys_message).to be_kind_of(Float)
    # end
    #
    ...
    # end
    #
    # it "i expect the data type of the sys_sunrise key to be a integer" do
    #   expect(@weatherio.get_sys_sunrise).to be_kind_of(Integer)
    # end
    #
    # it "i expect the data type of the sys_sunset key to be a integer" do
    #   expect(@weatherio.get_sys_sunset).to be_kind_of(Integer)
    # end
    #
    # it "i expect the data type of the id key to be a integer" do
    #   expect(@weatherio.get_id).to be_kind_of(Integer)
    # end
    #
    ...
    # end
    #
    # it "i expect the data type of the cod key to be a integer" do
